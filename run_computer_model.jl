...
function main()
    ...
    names = ["weertman_c_prefactor", "dimensionless_ungrounded_weertmanC_exponent", "glen_a_ref_prefactor", "melt_rate_prefactor", "bump_amplitude", "bump_duration", "per_century_trend"]
